...
This project explores how university students’ daily habits impact academic performance and mental health. Using two datasets from Kaggle, we merged a simulated dataset on student habits and academic performance with a survey on social media and mental health. After cleaning and merging the data by age and gender, we conducted regression analysis, correlation testing, and random forest modeling to investigate our three proposed research questions. We found that study hours were the strongest predictor of exam performance, with mental health also playing somewhat of a meaningful role. Social media usage, on the other hand, was negatively correlated with academic performance but showed no clear association with mental health. Our findings suggest that consistent study habits and emotional well-being are key to a student’s academic success, while the role of social media remains much more complex and subjective.  

## Introduction

University students often struggle to balance the demands of academic performance and mental well-being. In recent years, our attention has turned towards studying how lifestyle habits—such as sleep, study routines, and screen time—play a role in shaping these outcomes. Such research has suggested that sleep deprivation, excessive social media use, and poor time management can negatively impact both a student’s grade and mental health. However, it is still unclear which factor(s) have a more substantial impact on these outcomes, or if these conclusions are a result of a combination of habitual interactions.

Because of these ambiguities, our goal in this project is to investigate which student habits are most strongly associated with academic success and mental health. Specifically, we aim to answer the following research questions:
...
To explore these questions, we will analyze two datasets from Kaggle: one examining the relationship between student habits and academic performance, and another analyzing the impact of social media use on mental health. These datasets allow us to study a range of behavioral variables and assess how these habits correlate with outcomes in emotional well-being and exam scores.

Our findings are particularly relevant for university students who want to optimize their academic and personal health. Additionally, our work may be valuable to academic advisors, campus wellness staff, and educators seeking statistical insights to inform policy, outreach, and other support services. Ultimately, our analysis contributes to a broader understanding of how everyday behaviors shape two cornerstones of the college experience.
